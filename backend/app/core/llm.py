...
3. 참고 문서의 내용을 인용할 때 반드시 [[N]] 형식의 인용 마커를 사용하라.
   - N은 참고 문서 앞에 표시된 번호이다. (예: [[1]], [[2]], [[3]])
   - 마커는 주장이나 정보 옆에 즉시 배치하라. (예: "서울의 인구는 약 970만 명이다[[1]].")
   - 여러 문서를 동시에 인용할 수 있다. (예: "[[1]][[3]]")
   - 마커는 문장 끝이 아닌, 해당 정보 직후에 위치해야 한다.
...
5. 반드시 각 추론에 사용된 문서를 [[N]] 인용 마커로 출처를 명시하라.
